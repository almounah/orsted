...
func (c clientRequest) Post(client *Client, request *soap.SoapMessage) (string, error) {
	...
	debugger.Println("==== WinRM HTTP Request ====")
	debugger.Println("URL:", client.url)
	debugger.Println("Method:", req.Method)
	debugger.Println("Headers:")
	for k, v := range req.Header {
		debugger.Println(fmt.Sprintf("  %s: %v\n", k, v))
	}
	debugger.Println("Auth Username:", client.username)
	debugger.Println("SOAP Body:")
	...
	debugger.Println("==== WinRM HTTP Response ====")
	debugger.Println("Status:", resp.Status)
	debugger.Println("Headers:")
	...
	debugger.Println("Response Body:")
	debugger.Println(string(body))
	debugger.Println("============================")
	if err != nil {
		debugger.Println("Error In postt 2", err.Error())
